                ...
                <table align="center" width="600" border="0" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td style="padding: 20px;">
                            ...
                            <p style="font-size: 16px; color: #555;">Hi {{ ucfirst($paymentData['customer_name']) }},</p>

                            <p style="font-size: 16px; color: #555;">We have received your payment for the roofing project titled "{{ $paymentData['project_name'] }}".</p>
                            ...
                            <p style="font-size: 16px; color: #555; margin-top: 20px;">Thank you for choosing our services. We’ll be in touch with any further updates.</p>
                        </td>
                    </tr>
