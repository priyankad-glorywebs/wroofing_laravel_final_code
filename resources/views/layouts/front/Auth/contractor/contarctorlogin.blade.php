...
@section('title', 'Contractor Login')
		...
		<div class="row">
			<div class="col-12 col-lg-6 d-flex login-form-wrap align-items-lg-center min-height-100vh">
				<div class="login-wrap">
					...
					<div class="login-form-title text-center">Welcome to StructR Contractor</div>
					<div class="form-wrp">
						...
						<form id="logincontractor" method="POST" action="{{route('contractor.login')}}"
							...
							<div class="row align-items-center">
								...
								<div class="form-group col-6 text-end">
									<div class="forgotten-password">
										<a href="{{route('contractor.forgot.password')}}" class="forgot-password-link" id="forgot-password-link">Forgot Password?</a>
									</div>
								</div>
							</div>
							<div class="row">
						...
						<div class="register-now-wrap text-center">Login As a <a href="{{route('login')}}">Customer </a>
						</div>
						<div class="ordivider-wrap"><span>or sign in with</span></div>
						<div class="login-with-other-way">
							<div class="login-with-other-way-item">
								<a href="{{ url('login/google?type=contractor') }}"
							...
							<div class="login-with-other-way-item">
								<a href="{{ url('login/facebook?type=contractor') }}"
							...
							<div class="login-with-other-way-item">
								<a href="#" class="btn btn-outline-secondary"><span class="btn-icon"><svg width="16"
					...
					<div class="login-content-slider owl-carousel">
						<div class="login-content-slider-item">
							...
							<div class="login-content-detail"> 100% customer satisfaction rating combined with a
								<strong>perfect A+ rating with the BBB.</strong>
							</div>
						</div>
						<div class="login-content-slider-item">
							<div class="login-content-title title-divider">The Total Roofing Company. Serving DFW.</div>
...
<script>
    ...
    emailInput.addEventListener('input', function() {
        ...
        forgotPasswordLink.href = `{{route('contractor.forgot.password')}}?email=${email}`;
    });
</script>
@endsection