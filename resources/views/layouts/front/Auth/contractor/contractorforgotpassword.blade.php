...
@section('title', 'Forgot Password | Contractor')
				...
				<div class="col-12 col-lg-6 d-flex login-form-wrap align-items-lg-center min-height-100vh">
					<div class="login-wrap">
						...
						<div class="form-wrp">
							...
							<form id="forgotpasswordcontractor" method="POST" action="{{ route('contractor.send.reset.link') }}" enctype="multipart/form-data">
								@csrf
