...
<head>
    ...
    <link rel="resource" type="application/l10n" href="{{ asset('report_style/pdf/web/locale/locale.json') }}">
    <script src="{{ asset('report_style/pdf/build/pdf.mjs') }}" type="module"></script>
    <link rel="stylesheet" href="{{ asset('report_style/pdf/web/viewer.css') }}">
    <script src="{{ asset('report_style/pdf/web/viewer.mjs') }}" type="module"></script>
    <style>button#editorFreeText,button#editorInk,button#editorStamp,button#secondaryOpenFile{display: none;}</style>
    <script>
            ...
            <div class="findbar hidden doorHanger" id="findbar">
                <div id="findbarInputContainer">
                    <span class="loadingInput end">
                        <input id="findInput" class="toolbarField" title="Find" placeholder="Find in document…"
                            tabindex="91" data-l10n-id="pdfjs-find-input" aria-invalid="false">
                    </span>
                ...
                <div id="findbarOptionsOneContainer">
                    ...
                    <label for="findMatchCase" class="toolbarLabel"
                        data-l10n-id="pdfjs-find-match-case-checkbox-label">Match Case</label>
                </div>
                    ...
                    <div id="editorHighlightThickness">
                        ...
                        <div class="thicknessPicker">
                            <input type="range" id="editorFreeHighlightThickness" class="editorParamsSlider"
                                ...
                                min="8" max="24" step="1" tabindex="101">
                        </div>
                    </div>
                ...
                <div class="editorParamsToolbarContainer">
                    ...
                    <div class="editorParamsSetter">
                        ...
                        <input type="range" id="editorFreeTextFontSize" class="editorParamsSlider" value="10"
                            min="5" max="100" step="1" tabindex="104">
                    </div>
                </div>
            </div>
                ...
                <div class="editorParamsToolbarContainer">
                    ...
                    <div class="editorParamsSetter">
                        ...
                        <input type="range" id="editorInkThickness" class="editorParamsSlider" value="1"
                            min="1" max="20" step="1" tabindex="106">
                    </div>
                    <div class="editorParamsSetter">
                        ...
                        <input type="range" id="editorInkOpacity" class="editorParamsSlider" value="100"
                            min="1" max="100" step="1" tabindex="107">
                    </div>
                </div>
            </div>
            ...
            <div id="secondaryToolbar" class="secondaryToolbar hidden doorHangerRight">
                <div id="secondaryToolbarButtonContainer">
                    ...
                    <button id="presentationMode" class="secondaryToolbarButton" title="Switch to Presentation Mode"
                        tabindex="54" data-l10n-id="pdfjs-presentation-mode-button">
                    ...
                    <button id="pageRotateCcw" class="secondaryToolbarButton" title="Rotate Counterclockwise"
                        tabindex="59" data-l10n-id="pdfjs-page-rotate-ccw-button">
                    ...
                    <div id="spreadModeButtons" role="radiogroup">
                        <button id="spreadNone" class="secondaryToolbarButton toggled"
                            title="Do not join page spreads" tabindex="66" data-l10n-id="pdfjs-spread-none-button"
                            role="radio" aria-checked="true">
                    ...
                    <button id="documentProperties" class="secondaryToolbarButton" title="Document Properties…"
                        tabindex="69" data-l10n-id="pdfjs-document-properties-button"
                    ...
                    <div id="toolbarViewer">
                        <div id="toolbarViewerLeft">
                            <button id="sidebarToggle" class="toolbarButton" title="Toggle Sidebar" tabindex="11"
                                data-l10n-id="pdfjs-toggle-sidebar-button" aria-expanded="false"
                            ...
                            <span class="loadingInput start">
                                <input type="number" id="pageNumber" class="toolbarField" title="Page"
                                    value="1" min="1" tabindex="15" data-l10n-id="pdfjs-page-input"
                                    autocomplete="off">
                            </span>
                        ...
                        <div id="toolbarViewerRight">
                            <div id="editorModeButtons" class="splitToolbarButton toggled" role="radiogroup">
                                <button id="editorHighlight" class="toolbarButton" hidden="true"
                                ...
                                <button id="editorStamp" class="toolbarButton hidden" disabled="disabled"
                                    ...
                                    aria-controls="editorStampParamsToolbar" tabindex="34"
                            ...
                            <span id="scaleSelectContainer" class="dropdownToolbarButton">
                                <select id="scaleSelect" title="Zoom" tabindex="23"
                                    ...
                                    <option id="pageFitOption" title="" value="page-fit"
                                        data-l10n-id="pdfjs-page-scale-fit">Page Fit</option>
            ...
            <dialog id="documentPropertiesDialog">
                ...
                <div class="row">
                    <span id="modificationDateLabel"
                        data-l10n-id="pdfjs-document-properties-modification-date">Modification Date:</span>
