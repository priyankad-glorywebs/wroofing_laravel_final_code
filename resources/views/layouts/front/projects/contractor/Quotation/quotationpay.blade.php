                    ...
                    <div class="col-12">
                        ...
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item">
                                <a href="{{ URL('/contractor/list/' . base64_encode($quoteData->project_id)) }}">
                                    <svg width="5" height="9" viewBox="0 0 5 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M4.13654 8L1.25522 5.11869C0.914945 4.77841 0.914945 4.22159 1.25522 3.88131L4.13654 1"
          ...
          if (valid) {
            ...
            success: function (response) {
                if (response.success == true) {
                        ...
                        if(response.success == true && res != null){
                            setTimeout(function() {
                            ...
                            jQuery('#stripe-error-msg').text(res.message);
                            $('.paynow-box .card-info-box button').removeClass('disabled');
                        }
              ...
              error: function (jqXHR, exception) {
                if(jqXHR.responseJSON.success == false){
                  setTimeout(function() {
                    jQuery(document).find('.paynow-box .card-info-box button').removeClass('disabled');
                  }, 900);
